...
import com.silence5105.nosy.partner2go.TestPlaeAdapter;

/**
 * Created by Nosy on 2017/3/9.
 */
...
public class TestActivity extends AppCompatActivity
    ...
    private TestPlaeAdapter mAdapter;
...
//        mCurrentLocation.setOnClickListener(mOnClickListener);
        ...
        // the entire world.
        mAdapter = new TestPlaeAdapter(this, android.R.layout.simple_list_item_1,
    ...
    private AdapterView.OnItemClickListener mAutocompleteClickListener
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            /*
             ...
             read the place ID.
              */
            final TestPlaeAdapter.PlaceAutocomplete item = mAdapter.getItem(position);
    ...
    private static Spanned formatPlaceDetails(Resources res, CharSequence name, String id,
        ...
        Log.e(TAG, res.getString(Integer.parseInt("place_details"), name, id, address, phoneNumber,
                websiteUri));
        return Html.fromHtml(res.getString(Integer.parseInt("place_details"), name, id, address, phoneNumber,
                websiteUri));
