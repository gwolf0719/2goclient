...
public class ForgetPWOTPActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.forgetpasswordotpoptlayout);
...
//        pwtxt.setText(bundle.getString("password"));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.donbtn:
                String url = "http://uat.fofo.tw/2go_be/api/member_forget_pw_otp_chk?" + "email" + "=" + bundle.getString("mail") + "&" + "otp=" + otpedittxt.getText().toString();
...
//                            JSONObject jsonObject = new JSONObject(object.getJSONObject("object").getString("sys_code").toString());
                            ...
                            if (test.equals("200")) {
                                ...
                                intent.setClass(ForgetPWOTPActivity.this, NewPassWordActivity.class);
                                startActivity(intent);
                                ForgetPWOTPActivity.this.finish();
                            } else {
                                new AlertDialog.Builder(ForgetPWOTPActivity.this)
                                        .setTitle("")
                                        .setMessage("OTP 錯誤")
