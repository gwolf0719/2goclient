...
public class PrefsHelper {
    public static void getotpphonenumber(Context context, String otpphonenumber) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("otpphonenumber", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(PreferenceKeys.OTPPHONENUMBER.toString(), otpphonenumber);
        editor.commit();
    }

    public static String setotpphonenumber(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("otpphonenumber", Context.MODE_PRIVATE);
        return sharedPreferences.getString(PreferenceKeys.OTPPHONENUMBER.toString(), null);
    }
    public static void getpassword(Context context, String password) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("password", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(PreferenceKeys.PASSWORD.toString(), password);
        editor.commit();
    }

    public static String setpassword(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("password", Context.MODE_PRIVATE);
        return sharedPreferences.getString(PreferenceKeys.PASSWORD.toString(), null);
    }
