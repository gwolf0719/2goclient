...
import com.nnosy.taxigoclient.MyBookingAdapter;
import com.nnosy.taxigoclient.PrefsHelper;
import com.nnosy.taxigoclient.MyBookingItems;
...
//        GatewayAdpter gatewayAdpter = new GatewayAdpter(getActivity(), arrayList);
    ...
    public void loadlist1() {
        String url = "https://www.mmas.biz///api_booking/get_order_list?member_id=" + PrefsHelper.setphonenumber(getApplication());
